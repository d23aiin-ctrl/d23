...
// Social Links
const socialLinks = [
  { icon: Twitter, label: "Twitter", href: "#", color: "hover:bg-blue-50 hover:border-blue-300 hover:text-blue-500" },
  { icon: Instagram, label: "Instagram", href: "#", color: "hover:bg-pink-50 hover:border-pink-300 hover:text-pink-500" },
  { icon: Linkedin, label: "LinkedIn", href: "#", color: "hover:bg-blue-50 hover:border-blue-300 hover:text-blue-600" },
  { icon: Github, label: "GitHub", href: "#", color: "hover:bg-neutral-200 hover:border-neutral-400 hover:text-neutral-900" }
]
    ...
    <div className="min-h-screen bg-white text-neutral-900 overflow-x-hidden">
      ...
      <main className="relative z-10 pt-32 pb-20">
        <div className="max-w-6xl mx-auto px-6">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-neutral-200/80 bg-neutral-100 mb-6">
              <MessageCircle className="h-4 w-4 text-neutral-600" />
              <span className="text-sm text-neutral-600">Get in Touch</span>
            </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            >
                ...
                {contactInfo.map((info, i) => {
                  ...
                  return (
                    <a
                      ...
                      className="group flex items-center gap-4 p-4 rounded-2xl bg-white border border-neutral-200/80 shadow-sm hover:border-neutral-300 hover:shadow-md transition-all"
                    >
                      <div className={cn(
                      ...
                      <div>
                        <p className="text-xs text-neutral-500 uppercase tracking-wider">{info.label}</p>
                        <p className="text-neutral-900 font-medium group-hover:text-violet-600 transition-colors">
                          {info.value}
                        </p>
                      </div>
                    </a>
                ...
                {socialLinks.map((social, i) => {
                  ...
                  return (
                    <a
                      ...
                      className={cn(
                        "w-12 h-12 rounded-xl bg-neutral-100 border border-neutral-200 flex items-center justify-center text-neutral-500 transition-all",
                        social.color
                      )}
                      title={social.label}
                    >
              ...
              {/* Quick CTA */}
              <div className="mt-8 p-6 rounded-xl bg-gradient-to-b from-neutral-50 to-white border border-neutral-200">
                <h3 className="font-semibold text-neutral-900 mb-2">Prefer WhatsApp?</h3>
                ...
                <Link
                  href="https://wa.me/919934438606?text=Hey%20D23%20AI%21%20What%20can%20you%20do%3F"
                  target="_blank"
                  className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-gradient-to-r from-violet-600 to-indigo-600 text-white text-sm font-medium"
                >
            ...
            >
              <div className="bg-white rounded-2xl border border-neutral-200/80 p-8 shadow-lg">
                {submitted ? (
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                      <div>
                        ...
                        <input
                          ...
                          required
                          className="w-full px-4 py-3 rounded-xl bg-neutral-50 border border-neutral-200 text-neutral-900 placeholder:text-neutral-400 focus:outline-none focus:border-violet-500 transition-colors"
                      ...
                      <div>
                        <label className="block text-sm text-neutral-600 mb-2">Subject</label>
                        <input
                          type="text"
                      ...
                      <div>
                        ...
                        <textarea
                          ...
                          required
                          rows={5}
                          className="w-full px-4 py-3 rounded-xl bg-neutral-50 border border-neutral-200 text-neutral-900 placeholder:text-neutral-400 focus:outline-none focus:border-violet-500 transition-colors resize-none"
