      ...
      <div className="mx-auto max-w-6xl px-4">
        <div className="flex h-14 items-center justify-between rounded-2xl border bg-white/80 px-3 shadow-xl shadow-black/5 backdrop-blur">
          ...
          <div className="hidden items-center gap-2 md:flex">
            <button className="flex h-9 items-center gap-1 rounded-md border border-border px-3 text-sm font-medium text-foreground/70 transition hover:text-foreground">
              English
            ...
            >
              <Link href="https://wa.me/919934438606?text=Hey%20D23%20AI%21%20What%20can%20you%20do%3F" target="_blank" rel="noreferrer">
