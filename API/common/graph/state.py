...
def create_state_from_whatsapp(whatsapp_message: WhatsAppMessage) -> BotState:
    """Alias for create_initial_state for WhatsApp messages."""
    return create_initial_state(whatsapp_message)
